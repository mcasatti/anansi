...
\begin{figure}[H]
	\begin{ganttchart}[
		...
		\ganttbar{Análisis de técnicas\ganttalignnewline de detección de Clusters}{2023-03}{2023-09} \\
		\ganttbar{Análisis de técnicas\ganttalignnewline de detección de comunidades}{2023-06}{2023-12}\\
	\end{ganttchart}
	\caption*{Primer año}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\gantttitlecalendar{year, month} \\
		\ganttbar{Definición y extrapolación\ganttalignnewline de atributos}{2024-01}{2024-04}\\
		\ganttbar{Elaboración de\ganttalignnewline modelo de ML}{2024-04}{2024-10}\\
		\ganttbar{Entrenamiento de\ganttalignnewline modelo de ML}{2024-06}{2024-12}\\
	\end{ganttchart}
	\caption*{Segundo año}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\gantttitlecalendar{year, month} \\
		\ganttbar{Prueba de\ganttalignnewline modelo de ML}{2025-01}{2025-05}\\
		\ganttbar{Detección de clusters\ganttalignnewline sobre datos astronómicos}{2025-03}{2025-09}\\
		\ganttbar{Analisis comparativo\ganttalignnewline contra otras técnicas}{2025-06}{2025-12}
	\end{ganttchart}
	\caption*{Tercer año}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\gantttitlecalendar{year, month} \\
		\ganttbar{Elaboración de Tesis}{2026-01}{2026-06}\\
		\ganttbar{Revisión de Tesis}{2026-05}{2026-09}\\
		\ganttmilestone{Defensa de Tesis}{2026-10}
	\end{ganttchart}
	\caption*{Cuarto año}
\end{figure}
